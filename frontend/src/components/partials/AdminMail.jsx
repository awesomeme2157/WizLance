  ...
  return (
    <div className="px-6 mx-6 md:p-14 flex flex-col md:flex-row md:justify-around items-center gap-8 border border-gray-300 rounded-lg shadow-md">
      ...
      <div className="text-center md:text-left md:w-1/3">
        ...
        <p className="text-lg text-gray-600 mb-4 font-thin">
          Send a common mail to every user
        </p>
      </div>
        ...
        <form id="emailForm" className="w-full max-w-md">
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              id="mailMessage"
              rows="6"
              className="w-full p-3 border border-gray-400 rounded-md resize-none focus:outline-none focus:border-blue-500"
            ></textarea>
          </div>

          <button
            className="w-full py-3 bg-black text-white rounded-md hover:bg-pink-500 focus:outline-none focus:ring focus:ring-pink-400"
            type="submit"
          >
            Send
          </button>
