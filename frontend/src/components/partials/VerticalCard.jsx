...
const CustomCard = ({ array, isAlternate, cardIcon }) => (
  <VerticalTimelineElement
    ...
    icon={<div className="flex h-full">{cardIcon}</div>}
  >
    <div>
  ...
  return (
    <>
      <div className="text-white mx-6 my-12 bg-slate-950 bg-opacity-95 rounded-xl py-4 px-2">
        <h2 className="text-3xl text-center md:text-6xl font-light">
          Join the freelancing community.
        </h2>
          ...
          <VerticalTimeline>
            ...
            <CustomCard
              array={{
                title: "FINISH",
                content:
                  "Congratulations! You're now a freelancer. You can upload, edit and delete gig content.",
              }}
              isAlternate={true}
              cardIcon={<FaUsersLine />}
            />
          </VerticalTimeline>
        </div>
      </div>
