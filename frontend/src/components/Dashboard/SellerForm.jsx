          ...
          <form method="post" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-4 mt-4 ">
              <div className="flex flex-row gap-3 justify-between w-full">
                <div className="w-[50%]">
                  <label className="text-gray-900" htmlFor="main-dropdown">
                    Select Category
                  </label>
                  <select
                    id="main-dropdown"
                ...
                <div>
                  <label className="text-gray-900" htmlFor="secondary-dropdown">
                    Select Sub-Category
                  </label>
                  <select
              ...
              <div className="">
                <label
                  htmlFor="image"
                  className={imageSelected ? "text-blue-400" : "text-gray-900"}
                >
                  {imageSelected ? (
                    "Image Selected!"
                  ) : (
                ...
                />
                {file && <img src={file} alt="" style={{ width: "400px" }} />}
              </div>
            </div>
            <div>
